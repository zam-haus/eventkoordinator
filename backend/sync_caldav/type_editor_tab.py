"""sync_caldav's type-editor tab: field binding (events-and-sync.md §13.2),
...
#: The VEVENT properties sync_caldav's push() knows how to fill.
REMOTE_PROPERTIES = ["SUMMARY", "LOCATION", "DESCRIPTION", "DTSTART", "DTEND"]


class CalDAVBindingConfig(BaseModel):
...
def register() -> None:
    ...
    register_type_editor_tab("sync_caldav", "CalDAV Sync", CalDAVBindingConfig)
