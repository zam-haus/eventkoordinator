...
| **`event_publish_owner`** | Termin wird veröffentlicht (Nachricht an Owner) | Veranstaltungsname, Beginn, Ende, Call-Titel, Einreichungstitel, Link zum Termin | Einreicher darüber informieren, dass der Termin seiner Einreichung veröffentlicht wird | Einreicher (Owner) |
